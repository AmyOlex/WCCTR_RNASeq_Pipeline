## Amy Olex
## 08/30/2024 (updated from version on 10/03/2022)
...
## UPDATED 8/30/2024 to include an option for Harmony integration.
...
option_list = list(
  ...
  make_option(c("--harmony"), type="logical", 
              help="Optional. Performs Harmony dataset normalization. (Default = FALSE).",
              default = FALSE, action = "store_true", metavar="logical")
); 
