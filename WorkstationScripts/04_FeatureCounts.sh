...
do
	...
	prefix=$(basename $file .trimmed.Aligned.out.bam)
	featureCounts -t gene -g gene_id -p -s 0 --countReadPairs -T 48 -a /vcu_gpfs2/home/harrell_lab/refGenomes/merged_GDC_GRCh38_GRCm38_XMLV/merged_gencode_humanV22_mouseVM12.annotation.gtf -o $OUTDIR/$prefix-featureCounts.txt $file
